...
GitHub Issue, PR 본문, Plan Issue 누적 댓글, Architecture/Verification 공개 기록, PR 스크린샷/댓글은 `LocalNotes/github/draft`에서 초안을 작성한 뒤 `LocalNotes/github/public` 제출용 본문으로 변환합니다. `gh` CLI 업로드는 `LocalNotes/github/public` 파일만 사용합니다.
